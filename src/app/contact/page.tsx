      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-foreground">
          ...
          <div className="bg-muted/30 rounded-xl p-6 border border-border">
            ...
            <p className="text-sm text-muted-foreground">Follow us on Twitter/X for daily AI tool recommendations.</p>
          </div>
          <div className="bg-muted/30 rounded-xl p-6 border border-border">
            <h2 className="font-semibold mb-3">Business Inquiries</h2>
            <p className="text-sm text-muted-foreground">For advertising, sponsorship, or partnership opportunities, email us with the subject line &quot;Partnership Inquiry&quot;.</p>
          </div>
        </div>
      </main>
      <Footer />
